...
public class CraftConfig
{
    ...
    @Property(key = "gameserver.craft.delay", defaultValue = "2000")
    public static int CRAFT_DELAY;
    @Property(key = "gameserver.craft.period", defaultValue = "1900")
    public static int CRAFT_PERIOD;
    @Property(key = "gameserver.morph.delay", defaultValue = "3500")
    public static int MORPH_DELAY;
    @Property(key = "gameserver.morph.period", defaultValue = "3500")
    public static int MORPH_PERIOD;
