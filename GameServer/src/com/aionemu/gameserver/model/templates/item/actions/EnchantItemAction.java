...
public class EnchantItemAction extends AbstractItemAction
{
	...
	public boolean canAct(Player player, Item parentItem, Item targetItem) {
		...
		if ((msID != 167 && msID != 166) || tID >= 120 && wID != 187) {
			return false;
		} if ((targetItem.canAmplification()) &&
		    parentItem.getItemTemplate().isAmplificationStone() &&
			targetItem.getEnchantLevel() == targetItem.getItemTemplate().getMaxEnchantLevel() && !targetItem.isAmplified()) {
