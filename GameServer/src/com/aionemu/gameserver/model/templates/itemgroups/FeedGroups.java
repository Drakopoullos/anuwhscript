...
public final class FeedGroups
{
    ...
    @XmlType(name="InfernalDiabolApGroup")
    public static class InfernalDiabolApGroup extends FeedItemGroup
	{
	}
	
	@XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name="InnocentMerekXpGroup")
    public static class InnocentMerekXpGroup extends FeedItemGroup
	{
	}
	
	@XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name="ShugoCoinGroup")
    public static class ShugoCoinGroup extends FeedItemGroup
	{
	}
	
	@XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name="NewYearPetFoodGroup")
    public static class NewYearPetFoodGroup extends FeedItemGroup
	{
	}
