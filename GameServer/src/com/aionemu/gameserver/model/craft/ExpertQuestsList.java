...
public enum ExpertQuestsList
{
    ...
    MENUISIER_ELYOS(new int[] {19050, 19053, 1052, 19056, 19055, 19054}, Race.ELYOS, 40010), 
    MENUISIER_ASMODIANS(new int[] {29050, 29053, 29052, 29056, 29055, 29054}, Race.ASMODIANS, 40010);
