...
public class EngulfedOphidanBridgePlayerReward extends InstancePlayerReward
{
    ...
    public EngulfedOphidanBridgePlayerReward(Integer object, int timeBonus, byte buffId, Race race) {
        super(object);
    ...
    public void setOphidanVictoryBox(int reward) {
        this.ophidanVictoryBox = reward;
    }
