	...
	protected void runImpl() {
		...
		if (player == null) {
			...
			if (player.isInGroup2()) {
				...
				"You must leave your group or alliance to enter <Luna Instance>", ChatType.BRIGHT_YELLOW_CENTER), true);
				return;
			} else {
