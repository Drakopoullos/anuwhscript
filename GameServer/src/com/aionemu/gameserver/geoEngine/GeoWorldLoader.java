	...
	public static Map<String, Spatial> loadMeshs(String fileName) throws IOException {
		...
		while (geo.hasRemaining()) {
			...
			for (int c = 0; c < modelCount; c++) {
				...
				//log.info("namelenght:"+namelenght+" name:child_"+c+"_"+name+" modelCount:"+modelCount+" vectorCount:"+vectorCount*4+" triangles:"+triangles*2+" collisionF:"+m.getCollisionFlags());
			}
