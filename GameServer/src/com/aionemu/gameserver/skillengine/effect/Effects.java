...
public class Effects
{
	@XmlElements({
		...
		@XmlElement(name = "absolutesnare", type = AbsoluteSnareEffect.class),
		@XmlElement(name = "slow", type = SlowEffect.class),
		@XmlElement(name = "absoluteslow", type = AbsoluteSlowEffect.class),
		...
		@XmlElement(name = "returncoolreduce", type = ReturnCoolReduceEffect.class),
		@XmlElement(name = "odellarecoverincrease", type = OdellaRecoverIncreaseEffect.class),
		@XmlElement(name = "sprintfpreduce", type = SprintFpReduceEffect.class),
		@XmlElement(name = "deathpenaltyreduce", type = DeathPenaltyReduceEffect.class),
		...
		@XmlElement(name = "skillcooltimereset", type = SkillCooltimeResetEffect.class),
		@XmlElement(name = "riderobot", type = RideRobotEffect.class),
