...
public class CraftSkillUpdateService
{
	...
	private CraftSkillUpdateService() {
		//CRAFT ASMODIANS.
		npcBySkill.put(204096, new CraftLearnTemplate(30002, false, "Extract Vitality")); //Essencetapping (You can obtain materials through extracting the vitality of objects)
		npcBySkill.put(830158, new CraftLearnTemplate(30002, false, "Extract Vitality")); //Essencetapping (You can obtain materials through extracting the vitality of objects)
		npcBySkill.put(204257, new CraftLearnTemplate(30003, false, "Extract Aether")); //Aethertapping (You can obtain the Aether Crystals floating in the sky)
		npcBySkill.put(830148, new CraftLearnTemplate(30003, false, "Extract Aether")); //Aethertapping (You can obtain the Aether Crystals floating in the sky)
		...
		npcBySkill.put(798452, new CraftLearnTemplate(40010, true, "Menuisier")); //Construction Asmodians Pandaemonium.
		npcBySkill.put(798456, new CraftLearnTemplate(40010, true, "Menuisier")); //Construction Asmodians Pernon.
		
		//CRAFT ELYOS.
		npcBySkill.put(203780, new CraftLearnTemplate(30002, false, "Extract Vitality")); //Essencetapping (You can obtain materials through extracting the vitality of objects)
		npcBySkill.put(830066, new CraftLearnTemplate(30002, false, "Extract Vitality")); //Essencetapping (You can obtain materials through extracting the vitality of objects)
		npcBySkill.put(203782, new CraftLearnTemplate(30003, false, "Extract Aether")); //Aethertapping (You can obtain the Aether Crystals floating in the sky)
		npcBySkill.put(830064, new CraftLearnTemplate(30003, false, "Extract Aether")); //Aethertapping (You can obtain the Aether Crystals floating in the sky)
		...
		npcBySkill.put(798450, new CraftLearnTemplate(40010, true, "Menuisier")); //Construction Elyos Sanctum.
		npcBySkill.put(798454, new CraftLearnTemplate(40010, true, "Menuisier")); //Construction Elyos Oriel.
