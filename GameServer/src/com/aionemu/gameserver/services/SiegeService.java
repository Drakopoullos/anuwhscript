...
public class SiegeService
{
	...
	private FastMap<Integer, VisibleObject> treasureBoxSuccess = new FastMap<Integer, VisibleObject>();
	...
	public void broadcastUpdate(SiegeLocation loc, DescriptionId nameId) {
		...
		SM_SYSTEM_MESSAGE info = loc.getLegionId() == 0 ? new SM_SYSTEM_MESSAGE(1301039, loc.getRace().getDescriptionId(), nameId) : new SM_SYSTEM_MESSAGE(1301038, LegionService
			.getInstance().getLegion(loc.getLegionId()).getLegionName(), nameId);
