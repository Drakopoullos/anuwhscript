...
public class FFAService
{
    ...
    public FFAService() {
		...
		//Raksang Ruins.
		maps.add(new ArenaMap(300610000, 99, Arrays.asList(new Float[]{617f, 646f, 523f}, new Float[]{590f, 659f, 522f}, new Float[]{645f, 649f, 522f},
		new Float[]{676f, 687f, 522f}, new Float[]{577f, 704f, 522f}, new Float[]{632f, 735f, 522f})));
		//Occupied Rentus Base.
		maps.add(new ArenaMap(300620000, 99, Arrays.asList(new Float[]{148f, 363f, 257f}, new Float[]{194f, 349f, 257f}, new Float[]{228f, 303f, 255f},
		new Float[]{98f, 337f, 255f}, new Float[]{159f, 306f, 251f}, new Float[]{170f, 348f, 252f})));
		//Anguished Dragon Lord's Refuge.
		maps.add(new ArenaMap(300630000, 99, Arrays.asList(new Float[]{223f, 186f, 246f}, new Float[]{212f, 156f, 246f}, new Float[]{180f, 162f, 246f},
		new Float[]{180f, 194f, 246f}, new Float[]{212f, 200f, 246f}, new Float[]{196f, 175f, 246f})));
		//The Hexway.
		...
		//Nightmare Circus.
		maps.add(new ArenaMap(301160000, 99, Arrays.asList(new Float[]{479f, 566f, 202f}, new Float[]{524f, 592f, 200f}, new Float[]{521f, 534f, 199f},
		new Float[]{557f, 567f, 199f}, new Float[]{531f, 558f, 198f}, new Float[]{515f, 565f, 198f})));
		...
		maps.add(new ArenaMap(301400000, 99, Arrays.asList(new Float[]{343f, 727f, 398f}, new Float[]{393f, 781f, 398f}, new Float[]{430f, 740f, 398f},
		new Float[]{389f, 690f, 398f}, new Float[]{361f, 756f, 398f}, new Float[]{423f, 697f, 398f})));
		//Stonespear Reach.
		maps.add(new ArenaMap(301500000, 99, Arrays.asList(new Float[]{211f, 263f, 96f}, new Float[]{251f, 264f, 96f}, new Float[]{231f, 243f, 96f},
		new Float[]{230f, 286f, 96f}, new Float[]{231f, 264f, 95f}, new Float[]{216f, 247f, 96f})));
		//Sealed Argent Manor.
		maps.add(new ArenaMap(301510000, 99, Arrays.asList(new Float[]{1005f, 1088f, 69f}, new Float[]{988f, 1064f, 69f}, new Float[]{959f, 1072f, 69f},
		new Float[]{959f, 1104f, 69f}, new Float[]{988f, 1113f, 69f}, new Float[]{979f, 1089f, 70f})));
		//Archives Of Eternity.
		maps.add(new ArenaMap(301540000, 99, Arrays.asList(new Float[]{234f, 512f, 468f}, new Float[]{280f, 512f, 468f}, new Float[]{256f, 532f, 468f},
		new Float[]{256f, 492f, 468f}, new Float[]{256f, 512f, 468f}, new Float[]{236f, 493f, 468f})));
		//Cradle Of Eternity.
		...
		maps.add(new ArenaMap(301610000, 99, Arrays.asList(new Float[]{228f, 256f, 203f}, new Float[]{240f, 226f, 203f}, new Float[]{212f, 203f, 203f},
		new Float[]{188f, 222f, 203f}, new Float[]{193f, 257f, 203f}, new Float[]{211f, 274f, 202f})));
		//Theobomos Test Chamber [Elemental Athanor]
		maps.add(new ArenaMap(301610000, 99, Arrays.asList(new Float[]{258f, 119f, 196f}, new Float[]{310f, 120f, 195f}, new Float[]{288f, 101f, 195f},
		new Float[]{289f, 137f, 195f}, new Float[]{285f, 119f, 196f}, new Float[]{261f, 136f, 196f})));
		//Drakenseer's Lair.
		...
		maps.add(new ArenaMap(301630000, 99, Arrays.asList(new Float[]{229f, 184f, 164f}, new Float[]{229f, 208f, 160f}, new Float[]{229f, 226f, 160f},
		new Float[]{229f, 253f, 159f}, new Float[]{229f, 276f, 160f}, new Float[]{227f, 300f, 160f})));
		//Secret Munitions Factory.
		maps.add(new ArenaMap(301640000, 99, Arrays.asList(new Float[]{323f, 259f, 192f}, new Float[]{208f, 258f, 191f}, new Float[]{271f, 276f, 191f},
		new Float[]{272f, 243f, 191f}, new Float[]{354f, 266f, 195f}, new Float[]{244f, 258f, 191f})));
		//Fallen Poeta.
		...
		//Aether Mine.
		maps.add(new ArenaMap(301690000, 99, Arrays.asList(new Float[]{174f, 155f, 230f}, new Float[]{214f, 174f, 230f}, new Float[]{248f, 190f, 235f},
		new Float[]{281f, 205f, 242f}, new Float[]{315f, 227f, 250f}, new Float[]{326f, 263f, 258f})));
		//Old Fire Temple.
		maps.add(new ArenaMap(302000000, 99, Arrays.asList(new Float[]{370f, 250f, 117f}, new Float[]{355f, 280f, 110f}, new Float[]{394f, 289f, 110f},
		new Float[]{396f, 269f, 110f}, new Float[]{400f, 249f, 110f}, new Float[]{384f, 239f, 110f})));
		//Fissure Of Oblivion.
