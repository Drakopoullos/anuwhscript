...
public class TwoTeamSmallBg extends Battleground
{
    ...
    public TwoTeamSmallBg() {
        ...
        super.description = "Your must defeat the opposing team. There is " + maxRounds + " rounds. The team with the most won round, win's !!!";
        super.minSize = 2;
        super.maxSize = 4;
        super.teamCount = 2;
        super.mapId = 900140000; //don't tuch!!!
            ...
            for (PlayerGroup group : super.getGroups()) {
                for (Player pl : group.getMembers()) {
                    if (!pl.isAfk()) {
                        ...
                        PacketSendUtility.sendBrightYellowMessage(pl, "Teleport Player:" + pl.getName());
    ...
    public void onDie(final Player player, Creature lastAttacker) {
        ...
        if (lastAttacker instanceof Player && ((Player) lastAttacker).getObjectId() != player.getObjectId()) {
            ...
            if (killer.getPlayerGroup2() != null) {
                ...
                } if (deadCounter >= player.getPlayerGroup2().size()) {
    ...
    public boolean createTournament(List<List<Player>> teams) {
        ...
        this.maxRounds = 5;
        this.description = "Your must defeat the opposing team. There is " + maxRounds + " rounds. The team with the most won round, win's !!!";
        ...
        if (roundWinner != null) {
            ...
            if (!isDraw) {
                if (roundWinner != null) {
                    ...
                    super.specAnnounce(LadderService.getInstance().getNameByIndex(roundWinner.getBgIndex()) + " Win's the round!");
                    startNewRound();
                    return;
                }
            } else {
                ...
                super.specAnnounce("Draw!");
            }
        } if (extraTask != null) {
            extraTask.cancel(true);
        }
            ...
            for (PlayerGroup group : super.getGroups()) {
                if (group.getTeamId() == winner.getTeamId()) {
                    for (Player pl : group.getMembers()) {
                        ...
                        super.scheduleAnnouncement(pl, "Your team wins the match!", 0);
                    ...
                    for (Player pl : group.getMembers()) {
                        ...
                        super.scheduleAnnouncement(pl, "Your team lost the match!", 0);
                        super.scheduleAnnouncement(pl, "You have received rewards!", 3000);
                    }
                }
            }
