		...
		World.getInstance().getWorldMap(WorldMapType.LEVINSHOR.getId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
			...
			public void visit(Player player) {
				...
				if(player.getRace() == Race.ELYOS) {
					AbyssPointsService.addGp(player, 20000);
					ItemService.addItem(player, 186000442, 1000);
					ItemService.addItem(player, 188055496, 3);
					ItemService.addItem(player, 186000253, 100);
					ItemService.addItem(player, 186000242, 50);
				} else {
					AbyssPointsService.addGp(player, 10000);
					ItemService.addItem(player, 186000442, 500);
					ItemService.addItem(player, 188055496, 1);
					ItemService.addItem(player, 186000253, 50);
					ItemService.addItem(player, 186000242, 25);
				}
			}
