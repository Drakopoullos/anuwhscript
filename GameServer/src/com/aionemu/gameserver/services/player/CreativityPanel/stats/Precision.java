...
public class Precision implements StatOwner
{
	...
	public void onChange(Player player, int point) {
        if (point >= 1) {
            ...
            accuracy.add(new StatAddFunction(StatEnum.ACCURACY, (int) (5.6f * point), true));
			accuracy.add(new StatAddFunction(StatEnum.PHYSICAL_ACCURACY, (int) (3.75f * point), true));
			accuracy.add(new StatAddFunction(StatEnum.PHYSICAL_CRITICAL, (int) (3.50f * point), false));
            ...
            accuracy.clear();
			accuracy.add(new StatAddFunction(StatEnum.ACCURACY, (int) (5.6f * point), false));
			accuracy.add(new StatAddFunction(StatEnum.PHYSICAL_ACCURACY, (int) (3.75f * point), false));
			accuracy.add(new StatAddFunction(StatEnum.PHYSICAL_CRITICAL, (int) (3.50f * point), false));
